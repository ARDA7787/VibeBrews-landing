...
app.post('/chats', authMiddleware, async (req: AuthRequest, res) => {
  ...
  await db.run('INSERT INTO messages (chat_id, role, content) VALUES (?, "agent", ?)', chatId, 'Hey, welcome! I will help you get a life insurance.');
    await db.run('INSERT INTO messages (chat_id, role, content) VALUES (?, "agent", ?)', chatId, 'Could you please provide your personal data first?');
    await db.run('INSERT INTO messages (chat_id, role, content) VALUES (?, "agent", ?)', chatId, 'Let\'s start: what is your age?');
